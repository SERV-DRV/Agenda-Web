...
let EditToDoListForm = function (tarea) {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (tareaEnDb) {
            ...
            if (contenedorTarea) {
                contenedorTarea.querySelector(".item-todolist__text").textContent = inputTitulo.value;
                contenedorTarea.querySelector(".item-todolist__fecha").textContent = inputFecha.value;
                contenedorTarea.querySelector(".item-todolist__descripcion").textContent = inputDescripcion.value;
            }
